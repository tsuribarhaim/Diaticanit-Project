    ...
    messages: [
      ...
      },
      {
        ...
        content: [
          ...
          "- WATER FIELD SCOPE: waterMl means free liquid actually drunk (water, tea, coffee, soda, juice, milk, a soup's broth, etc.) - it feeds the user's fluid-intake tracker specifically, not general food moisture. For a solid or semi-solid food item (yogurt, fruit, vegetables, meat, bread, and similar - anything eaten rather than drunk), waterMl must be 0 regardless of how much water that food actually contains, even though the \"never leave estimates at 0\" rule above applies to every other nutrient field on that same item.",
        ...
        content: [
          {
            ...
            text: [
              ...
              "- WATER FIELD SCOPE: waterMl means free liquid actually drunk (water, tea, coffee, soda, juice, milk, a soup's broth, etc.) - it feeds the user's fluid-intake tracker specifically, not general food moisture. For a solid or semi-solid food item visible in the photo (yogurt, fruit, vegetables, meat, bread, and similar - anything eaten rather than drunk), waterMl must be 0 regardless of how much water that food actually contains, even though the \"never leave estimates at 0\" rule above applies to every other nutrient field on that same item.",
